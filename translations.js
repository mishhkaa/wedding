...
const translations = {
    ua: {
        ...
        testimonial1Names: "ОЛЕКСАНДР ТА АННА, DESTINATION WEDDING",
        ...
        testimonial2Names: "ВОЛОДИМИР ТА АННА, DESTINATION WEDDING",
        ...
        // Common CTA copies
        discussEventIdea: "обговорити ідею вашої події",
        jkoCtaButton: "переглянути івент",
        jkoConsultationBtn: "запланувати консультацію з юлією щодо вашої події",
        // Proposals button (exact copy for that section)
        proposalsBtn: "ОБГОВОРИТИ ІДЕЮ ПОДІЇ",

        // Portfolio page
        portfolioHeroTitle: "portfolio",
        portfolioTopStickyCta: "Поділіться з нами своєю мрією і ми допоможемо перетворити її на подію, створену саме для вас",
        galleryKicker: "gallery",
        weddingTitle: "wedding",
        weddingDesc: "Пориньте у світ романтики та подорожей разом із нашою галереєю весіль і подій у різних локаціях. Від камерних церемоній до масштабних міжнародних святкувань — J.KO Gallery створює події, що залишають сильне враження та поєднують у собі елегантність, яка не залежить від часу.",
        ...
        partiesTitle: "авторські parties",
        partiesDesc: "Події, у яких стиль визначає структуру, а кожне рішення має свою функцію і працює на загальну композицію. Вечори та вечірки різного масштабу формуються як індивідуальні концепції з точно вибудуваним сценарієм, світлом, музикою та візуальною подачею, що відповідає рівню події й характеру простору.",
        childrenTitle: "дитячі свята",
        childrenDesc: "Свята, створені з увагою до дитини та відчуття сім’ї, де кожна деталь має своє місце і значення. Кожен проєкт формується як індивідуальна історія, у якій враховується характер дитини, атмосфера родини і простір події, щоб усе виглядало природно і цілісно. Візуальна подача, сценарій і динаміка поєднуються так, щоб дитині було цікаво й комфортно, а дорослим — естетично і спокійно, створюючи теплий досвід, який залишається в пам’яті.",
        parties2Title: "Камерні & girls parties",
        parties2Desc: "Події, створені для близького кола, де важлива атмосфера, настрій і відчуття моменту. Камерні вечори та girls parties формуються як індивідуальні концепції з продуманою візуальною подачею, сценарієм і деталями, що підкреслюють характер події та стиль учасниць. Простір наповнюється світлом, настроєм і деталями, які тонко підтримують атмосферу вечора, залишаючи відчуття естетики, близькості й часу, проведеного зі смаком.",
        lecturesTitle: "авторські Лекції & тематичні свята",
        lecturesDesc: "Події, у яких ідея задає не лише тему, а спосіб мислення простору, ритм взаємодії та рівень сприйняття. Авторські лекції й тематичні вечори формуються як індивідуальні концепції з точно вибудуваною драматургією, де зміст, візуальна мова і середовище працюють синхронно, створюючи інтелектуально насичений і естетично вивірений формат. Кожен проєкт залишає після себе не просто враження, а чітке відчуття прожитого досвіду, до якого хочеться повертатися.",
        jkoTitle: "j.Ko birthday party",
        jkoDesc: "Подія, зібрана як цілісний вечір із власним ритмом, настроєм і візуальною мовою. J.KO Birthday Party вибудовується через світло, музику, простір і деталі, які працюють узгоджено і задають відчуття динаміки та рівня, створюючи атмосферу, в якій кожен момент відчувається точно, проживається глибше і залишає після себе стан, до якого хочеться повертатися.",
        
        // Footer
        footerAbout: "ЗАСНОВНИЦЯ",
    ...
    ru: {
        ...
        testimonial1Names: "OLEKSANDR & ANNA, DESTINATION WEDDING",
        ...
        testimonial2Names: "VLADIMIR & ANNA, DESTINATION WEDDING",
        ...
        // Common CTA copies
        discussEventIdea: "ОБСУДИТЬ ИДЕЮ ВАШЕГО СОБЫТИЯ",
        jkoCtaButton: "посмотреть ивент",
        jkoConsultationBtn: "запланировать консультацию с Юлией по вашему событию",
        proposalsBtn: "ОБСУДИТЬ ИДЕЮ СОБЫТИЯ",

        // Portfolio page (placeholders: mirror UA until provided)
        portfolioHeroTitle: "portfolio",
        portfolioTopStickyCta: "Поделитесь с нами своей мечтой, и мы поможем превратить ее в событие, созданное именно для вас",
        galleryKicker: "gallery",
        weddingTitle: "wedding",
        weddingDesc: "Пориньте у світ романтики та подорожей разом із нашою галереєю весіль і подій у різних локаціях. Від камерних церемоній до масштабних міжнародних святкувань — J.KO Gallery створює події, що залишають сильне враження та поєднують у собі елегантність, яка не залежить від часу.",
        proposalsTitle: "пропозиції",
    ...
    en: {
        ...
        // Common CTA copies
        discussEventIdea: "discuss your event idea",
        jkoCtaButton: "view event",
        jkoConsultationBtn: "schedule a consultation with Yulia about your event",
        proposalsBtn: "DISCUSS YOUR EVENT IDEA",

        // Portfolio page (EN placeholders; adjust if needed)
        portfolioHeroTitle: "portfolio",
        portfolioTopStickyCta: "Share your dream with us and we will help transform it into an event created just for you",
        galleryKicker: "gallery",
        weddingTitle: "wedding",
        weddingDesc: "Dive into the world of romance and travel with our gallery of weddings and events across different locations. From intimate ceremonies to large international celebrations — J.KO Gallery creates events that leave a strong impression and combine timeless elegance.",
        proposalsTitle: "proposals",
        proposalsDesc: "Immerse yourself in a moment where the decision takes the shape of an event created as an individual concept with precise aesthetics, scenario, and space. From intimate formats to complex productions in different locations — each project is formed with the couple's character and event context in mind, where all elements work cohesively toward a single impression.",
        partiesTitle: "author’s parties",
        partiesDesc: "Events where style defines structure, and every decision has a function that serves the overall composition. Evenings and parties of various scales are formed as individual concepts with a carefully built scenario, light, music, and visual presentation that match the level and character of the space.",
        childrenTitle: "children’s holidays",
        childrenDesc: "Celebrations created with attention to the child and the feeling of family, where every detail has its place and meaning. Each project is formed as an individual story, taking into account the child's character, the family's atmosphere, and the event space, so everything looks natural and holistic.",
        parties2Title: "intimate & girls parties",
        parties2Desc: "Events created for close circles, where atmosphere, mood, and a sense of the moment are important. Intimate evenings and girls parties are formed as individual concepts with thoughtful visual presentation, scenario, and details that emphasize the character of the event and the style of the participants.",
        lecturesTitle: "author lectures & thematic holidays",
        lecturesDesc: "Events where the idea sets not only the theme but a way of thinking about space, interaction rhythm, and perception level. Author lectures and thematic evenings are formed as individual concepts with precisely constructed dramaturgy...",
        jkoTitle: "j.Ko birthday party",
        jkoDesc: "An event assembled as a holistic evening with its own rhythm, mood, and visual language...",
